...
const CollectionDetails = ({screenNumCallback}) => {
    const [state, dispatch] = ContextValue();
    ...
    return (
        ...
        <div>
            ...
            <div style={styles.collectionProfile} >
                <img src={typeof state.currentCollection.image !== 'undefined' ? state.currentCollection.image : null}  alt={state.currentCollection.name} style={styles.collectionAvatar}/>
                <span style={{marginTop:"3.5vh"}} >
                    {typeof state.currentCollection.name !== 'undefined' ? state.currentCollection.name : "None"}
                </span>
                <div style={styles.collectionData} >
